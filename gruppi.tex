...
\end{prop}
\begin{proof}
	La funzione \fun{\Phi}{G}{\Int{G}}{g}{\varphi_g} è un omomorfismo con kernel $ Z(G) $.
\end{proof}
...
\begin{itemize}
	...
	\item $ \left[\varphi_h =  id, \, \text{ord}(h) =4\right] $. Abbiamo che $ gh $ è non vive qua dentro e il gruppo è abeliano.

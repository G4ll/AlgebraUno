...
\[ \begin{tikzcd}
& \text{esistono elementi di ordine 8?} \arrow{r}{\text{sì}} \arrow[swap]{d}{no} & \mathbb{Z}_8 \\
& \text{tutti gli elementi hanno ordine 2?} \arrow{r}{\text{sì}} \arrow[swap]{d}{no} & \mathbb{Z}_2 \times \mathbb{Z}_2 \times \mathbb{Z}_2 \\
& \text{esiste } h \notin C_4 \text{ di ordine 4?} \arrow{dr}{\text{no}} \arrow{dl}{\text{sì}} \\
\text{il coniugio per }h\text{ cos'è?} \arrow{d}{\text{-id}} \arrow{dr}[swap]{\text{id}}  & & \text{il coniugio per }h\text{ cos'è?} \arrow{d}{\text{-id}} \arrow{dl}[swap]{\text{id}}\\
Q_8 & \mathbb{Z}_2 \times \mathbb{Z}_4 & D_4
\end{tikzcd}
\]

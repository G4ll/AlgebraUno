...
\end{theorem}
\begin{proof}
	Il grado di $ \mu_\alpha $ è $ n $, che dunque ammette esattamente $ n $ radici distinte. Il teorema \ref{est} conclude.
\end{proof}
\begin{remark}
...
\end{prop}
	...
	\begin{prop}[del gruppo all'esponente]\label{cosetta1}
	...
	\begin{prop}[che coniuga l'esponente]
	...
	dunque il Primo Teorema di Omomorfismo (tra gruppi!) ci serve la tesi.
	\end{proof}
